...
| TC-006 | P1 | Licence summaries | Which licence groups can appear in Trust Center: guarding only, guarding + security technology, or legal page link only? | Catalog allows guarding and security technology summary; private investigation is legal-only. | Include guarding and security technology summary only; link exact details to Impresszum / Legal Notice. | Legal / proof owner |
