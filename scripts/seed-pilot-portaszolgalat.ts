  ...
  trustItems: [
    ...
    },
    {
      ...
      body:
        ...
        "riportálással kapcsolják össze, így a recepciós és portai működés, valamint a " +
...
async function main() {
  ...
  console.log(banner);
  ensureStagingDbTarget({ scriptName: "seed-pilot-portaszolgalat", isDryRun });
