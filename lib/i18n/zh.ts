export const zh = {
  ...
  "hero": {
    ...
    "h1a": "降低风险。",
    "h1b": "加强管控。",
    "sub": "Avenir 将您的安保运营统一整合：驻场安保、出入管理、安防技术、现场检查与报告。只需一份合同，一个责任明确的对接人。",
    "cta1": "我们的服务",
    "cta2": "获取报价",
  ...
  "aboutTitle": "关于Avenir",
  "aboutSub": "安保服务 · 稳定运营",
  "aboutText": "Avenir 成立于 2018 年，但我们的管理团队和专业人员在设施管理和安保服务领域拥有数十年的经验。如今，我们拥有 200 多名专业人员，在全国 30 多个运营现场提供服务，覆盖企业、商业、工业和物流环境。\n\n我们负责统筹安保运营，包括驻场安保、出入管理、巡逻服务、事件处理和报告。我们的目标是减少客户日常协调成本，降低风险，并提升现场运营的透明度。\n\n在需要时，我们会以安防技术、神秘顾客评估以及相关设施管理支持来补充核心安保服务。这样，客户无需协调多个独立服务商，而是可以与一个责任明确的合作伙伴对接。",
  "values": [
    {
      "t": "透明管控",
      "d": "通过清晰流程、可追溯记录和定期沟通，帮助客户更好地掌握现场服务运行。"
    },
    {
      "t": "专业现场支持",
      "d": "训练有素的团队和统一的现场规范，为客户场所提供稳定、专业的服务支持。"
    },
    {
      "t": "响应与责任",
      "d": "当出现异常、事件或变更需求时，明确的升级路径和责任联系人有助于及时处理。"
    }
  ],
  "servicesTitle": "我们的服务",
  "servicesSub": "一站式综合解决方案",
  "services": [
    {
      "id": "security",
      "icon": "shield",
      "t": "驻场安保服务",
      "d": "由训练有素的安保人员提供人身及财产安全保护：驻场安保、巡逻服务、出入管理支持和事件处理，适用于工业、商业和办公环境。"
    },
    {
      "id": "cleaning",
      "icon": "sparkle",
      "t": "活动安保",
      "d": "按照约定流程为企业活动、会议和专项活动提供安保服务：出入管理、现场值守、巡逻和事件处理。"
    },
    {
      "id": "building",
      "icon": "camera",
    ...
    },
    {
      ...
      "icon": "desk",
      "t": "前台与门岗服务",
      "d": "专业规范的门岗和前台服务：访客接待、出入管理、钥匙管理、包裹接收以及租户沟通，支持日常运营。"
    },
    {
      "id": "green",
      "icon": "leaf",
      "t": "Soft FM（软性设施管理）",
      "d": "作为补充服务，统筹清洁、绿化维护和现场管理事务，以受控质量和单一责任对接人支持客户运营。"
    },
    {
      "id": "technical",
      "icon": "radar",
    ...
    },
    {
      ...
      "icon": "eye",
      "t": "神秘顾客评估与现场审核",
      "d": "在真实客户和运营场景中开展神秘顾客评估、服务质量检查和现场审核，并提供独立评估与结构化报告。"
    },
    {
      "id": "hardfm",
      "icon": "gear",
  ...
  "legal": {
    ...
    "terms": {
      ...
      "sections": [
        ...
        { "id": "contact-form", "title": "3. 联系表单的使用", "body": "表单仅用于报价请求和联系。服务提供方会审阅收到的咨询，并最迟在下一个工作日通过所提供的联系方式之一与咨询人联系。报价准备所需时间取决于需求的范围、复杂程度以及必要的沟通。" },
